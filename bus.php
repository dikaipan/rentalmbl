...
<body>
							   ...
							   <div class="navbar-header">
								 ...
								 <div id="navbarCollapse" class="collapse navbar-collapse">
							      <ul class="nav navbar-nav">
							               ...
							               <li class="active"><a href="#"><span class="glyphicon glyphicon-home"></span> Katalog</a></li>
							            </ul>
				...
				<div class="bus-btm wow zoomIn animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomIn;">
					<div class="container-fluid">
						<ul>
							...
							<li class="hr"><a href="#" style="margin-left:  15px">Harga</a></li>
								<div class="clearfix"></div>
						</ul>
					</div>
				</div>
